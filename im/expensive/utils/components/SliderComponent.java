...
public class SliderComponent {
    ...
    public SliderComponent(float x, float y, float width, float height, int min2, int max2, String name) {
        this.x = x;
        this.y = y;
        this.width = width;
        this.height = height;
    ...
    public SliderComponent(float x, float y, float width, float height, int min2, int max2, Enchantment enchantment, String name) {
        this.x = x;
        this.y = y;
        this.width = width;
        this.height = height;
