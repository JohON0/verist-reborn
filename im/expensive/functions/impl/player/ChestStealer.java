...
@FunctionRegister(name="AutoMist", type=Category.Player)
public class ChestStealer
extends Function {
    private final SliderSetting delay = new SliderSetting("\u0417\u0430\u0434\u0435\u0440\u0436\u043a\u0430", 100.0f, 0.0f, 1000.0f, 1.0f);
    private final StopWatch stopWatch = new StopWatch();
    private final List<Item> ingotItemList = List.of((Object)Items.IRON_INGOT, (Object)Items.GOLD_INGOT, (Object)Items.NETHERITE_INGOT, (Object)Items.DIAMOND, (Object)Items.NAUTILUS_SHELL, (Object)Items.NETHERITE_SCRAP);
    ...
    public void onUpdate(EventUpdate e) {
        ...
        if (container instanceof ChestContainer) {
            ...
            for (int index = 0; index < lowerChestInventory.getSizeInventory(); ++index) {
                ...
                ChestStealer.mc.playerController.windowClick(container2.windowId, index, 0, ClickType.QUICK_MOVE, Minecraft.player);
    ...
    private void moveItem(ChestContainer container, int index, int multi) {
        for (int i = 0; i < multi; ++i) {
            ChestStealer.mc.playerController.windowClick(container.windowId, index + i, 0, ClickType.QUICK_MOVE, Minecraft.player);
        }
    }
