...
@FunctionRegister(name="Xray HolyWorld", type=Category.Render)
public class XrayBypass
extends Function {
    CopyOnWriteArrayList<BlockPos> waiting = new CopyOnWriteArrayList();
    public SliderSetting up = new SliderSetting("\u0412\u044b\u0441\u043e\u0442\u0430 \u0432\u0435\u0440\u0445", 5.0f, 0.0f, 30.0f, 1.0f);
    public SliderSetting down = new SliderSetting("\u0412\u044b\u0441\u043e\u0442\u0430 \u0432\u043d\u0438\u0437", 5.0f, 0.0f, 30.0f, 1.0f);
    public SliderSetting radius = new SliderSetting("\u0420\u0430\u0434\u0438\u0443\u0441 \u043e\u043a\u043e\u043b\u043e \u0438\u0433\u0440\u043e\u043a\u0430", 20.0f, 0.0f, 30.0f, 1.0f);
    public SliderSetting delay = new SliderSetting("\u0417\u0430\u0434\u0435\u0440\u0436\u043a\u0430 \u043d\u0430 \u0441\u043a\u0430\u043d", 13.0f, 0.0f, 40.0f, 1.0f);
    public SliderSetting skip = new SliderSetting("\u0421\u043a\u043e\u043b\u044c\u043a\u043e \u0431\u043b\u043e\u043a\u043e\u0432 \u043f\u0440\u043e\u043f\u0443\u0441\u0442\u0438\u0442", 3.0f, 1.0f, 5.0f, 1.0f);
        ...
        this.thread = new Thread(() -> {
            if (Minecraft.player != null) {
                for (BlockPos click : this.waiting) {
                    Minecraft.player.connection.sendPacket(new CPlayerDiggingPacket(CPlayerDiggingPacket.Action.START_DESTROY_BLOCK, click, Direction.UP));
    ...
    private int isValid(BlockPos pos) {
        ...
        if (block2 instanceof OreBlock) {
            OreBlock ore = (OreBlock)block2;
    ...
    public void onPacket(EventPacket e) {
        if (this.thread != null && this.thread.isAlive() && e.isSend()) {
    ...
    public void onDisplay(EventDisplay e) {
        ...
        Fonts.montserrat.drawText(e.getMatrixStack(), time, x + width - Fonts.montserrat.getWidth(time, 8.0f) - 5.0f, 15.0f, -1, 8.0f);
    }
    ...
    CopyOnWriteArrayList<BlockPos> getBlocks() {
        ...
        int dis = ((Float)this.radius.get()).intValue();
        int up = ((Float)this.up.get()).intValue();
        int down = ((Float)this.down.get()).intValue();
        for (int y = up; y >= -down; --y) {
            for (int x = dis; x >= -dis; --x) {
                for (int z = dis; z >= -dis; --z) {
                    ...
                    if (block2 instanceof AirBlock) continue;
                    blocks.add(pos);
                }
            }
        }
