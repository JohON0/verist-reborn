...
public class NoSlow extends Function {
    private final ModeSetting mode = new ModeSetting("Мод", "Matrix", new String[]{"Matrix", "Grim", "RW", "RW2"});
    int ticks = 0;
        ...
        if (Minecraft.player.isHandActive()) {
            switch ((String)this.mode.get()) {
                ...
                case "Matrix":
                    ...
                    break;
                case "RW":
                    this.handleGrimACMode1(eventNoSlow);
                    break;
                case "RW2":
    ...
    private void handleGrimNew(NoSlowEvent noSlow) {
        ...
        if (Minecraft.player != null) {
            ...
            if (!Minecraft.player.isElytraFlying()) {
                ...
                var10000 = mc;
                if ((float)Minecraft.player.getFoodStats().getFoodLevel() < 6.0F) {
                    var10000 = mc;
