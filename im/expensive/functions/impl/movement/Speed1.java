...
@FunctionRegister(name="SpeedHW", type=Category.Movement)
public class Speed1
extends Function {
    ...
    public void rotation(EventMotion e) {
        if (Minecraft.player.isOnGround()) {
            this.options.getValueByName("\u0420\u0430\u0431\u043e\u0442\u0430\u0442\u044c \u0432 \u0432\u043e\u0437\u0434\u0443\u0445\u0435").get();
        }
        if (((Boolean)this.options.getValueByName("\u0420\u043e\u0442\u0430\u0446\u0438\u044f \u0438\u0433\u0440\u043e\u043a\u0430").get()).booleanValue() && e instanceof EventMotion) {
    ...
    public void onUpdate(EventUpdate e) {
        ...
        switch (this.mode.getIndex()) {
            case 0: {
                ...
                Vector3d vector3d = new Vector3d(target.getX(), target.getY(), target.getZ());
                BlockRayTraceResult result = new BlockRayTraceResult(vector3d, Direction.UP, target, false);
    ...
    public int getNeed(boolean isHotbar, Item item) {
        int hot = isHotbar ? 0 : 9;
        int inv = isHotbar ? 9 : 36;
        int finalSlot = 0;
