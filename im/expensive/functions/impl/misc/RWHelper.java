...
extends Function {
    ...
    private void windows(String name, String desc, boolean error2) {
        this.print(desc);
        if (SystemTray.isSupported()) {
            try {
                ...
                this.trayIcon.displayMessage(name, desc, error2 ? TrayIcon.MessageType.ERROR : TrayIcon.MessageType.INFO);
