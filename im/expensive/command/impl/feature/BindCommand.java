...
CommandWithAdvice {
    ...
    public List<String> adviceMessage() {
        ...
        return List.of((Object)(commandPrefix + "bind add <function> <key> - \u0414\u043e\u0431\u0430\u0432\u0438\u0442\u044c \u043d\u043e\u0432\u044b\u0439 \u0431\u0438\u043d\u0434"), (Object)(commandPrefix + "bind remove <function> <key> - \u0423\u0434\u0430\u043b\u0438\u0442\u044c \u0431\u0438\u043d\u0434"), (Object)(commandPrefix + "bind list - \u041f\u043e\u043b\u0443\u0447\u0438\u0442\u044c \u0441\u043f\u0438\u0441\u043e\u043a \u0431\u0438\u043d\u0434\u043e\u0432"), (Object)(commandPrefix + "bind clear - \u041e\u0447\u0438\u0441\u0442\u0438\u0442\u044c \u0441\u043f\u0438\u0441\u043e\u043a \u0431\u0438\u043d\u0434\u043e\u0432"), (Object)("\u041f\u0440\u0438\u043c\u0435\u0440: " + TextFormatting.RED + commandPrefix + "bind add KillAura R"));
    }
    ...
    private void removeBindFromFunction(Parameters parameters, Logger logger) {
        String functionName = parameters.asString(1).orElseThrow(() -> new CommandException(TextFormatting.RED + "\u0423\u043a\u0430\u0436\u0438\u0442\u0435 \u043d\u0430\u0437\u0432\u0430\u043d\u0438\u0435 \u0444\u0443\u043d\u043a\u0446\u0438\u0438!"));
        String keyName = parameters.asString(2).orElseThrow(() -> new CommandException(TextFormatting.RED + "\u0423\u043a\u0430\u0436\u0438\u0442\u0435 \u043a\u043d\u043e\u043f\u043a\u0443!"));
        Expensive.getInstance().getFunctionRegistry().getFunctions().stream().filter(f -> f.getName().equalsIgnoreCase(functionName)).forEach(f -> {
            f.setBind(0);
    ...
    private void listBoundKeys(Logger logger) {
        ...
        Expensive.getInstance().getFunctionRegistry().getFunctions().stream().filter(f -> f.getBind() != 0).map(f -> {
