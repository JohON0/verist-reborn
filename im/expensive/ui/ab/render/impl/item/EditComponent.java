...
import im.expensive.ui.ab.render.impl.item.EnchantmentWidget;
...
implements IMinecraft {
    ...
    public void render(MatrixStack stack, int mouseX, int mouseY) {
        Scissor.push();
        Scissor.setFromComponentCoordinates(this.x - 50.0f, this.y - 50.0f, 200.0, 200.0);
        DisplayUtils.drawRoundedRect(this.x - 1.0f, this.y - 1.0f, 102.0f, 102.0f, new Vector4f(4.0f, 4.0f, 4.0f, 4.0f), new Vector4i(ColorUtils.getColor(0), ColorUtils.getColor(90), ColorUtils.getColor(180), ColorUtils.getColor(260)));
        ...
        mc.getItemRenderer().renderItemAndEffectIntoGUI1(this.stack, (int)this.x + 5, (int)this.y + 5);
        ...
        if (this.stack.isEnchantable()) {
            ...
            this.enchantmentWidget.setY(this.y + 95.0f);
