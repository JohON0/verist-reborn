...
public class SearchField {
    ...
    public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
        DisplayUtils.drawRoundedRect((float)this.x, (float)this.y, (float)this.width, (float)this.height, new Vector4f(5.0f, 5.0f, 5.0f, 5.0f), ColorUtils.rgba(18, 18, 18, 160));
