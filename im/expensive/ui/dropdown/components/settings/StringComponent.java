...
extends Component {
    ...
    private static StringComponent currentlySelectedComponent = null;
    ...
    public void render(MatrixStack stack, float mouseX, float mouseY) {
        ...
        this.drawSettingName(stack, settingName, x, y - 17.0f);
    ...
    private void drawTextWithLineBreaks(MatrixStack stack, String text, float x, float y, float maxWidth) {
        ...
        for (int var10 = 0; var10 < var9; ++var10) {
            ...
            for (String wrappedLine : wrappedLines) {
                Fonts.montserrat.drawText(stack, wrappedLine, x, currentY, ColorUtils.rgba(255, 255, 255, 64), 6.0f);
    ...
    private void drawSettingName(MatrixStack stack, String settingName, float x, float y) {
        Fonts.montserrat.drawText(stack, settingName, x, y + 10.0f, -1, 6.0f);
    }

    private void drawBackground(float x, float y, float width, float height) {
        DisplayUtils.drawRoundedRect(x, y, width, height, 4.0f, ColorUtils.rgba(0, 0, 0, 128));
    }

    @Override
    public void charTyped(char codePoint, int modifiers) {
        if (currentlySelectedComponent == this && (!this.setting.isOnlyNumber() || NumberUtils.isNumber(String.valueOf(codePoint)))) {
