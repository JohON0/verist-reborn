...
extends Component {
    ...
    public void render(MatrixStack stack, float mouseX, float mouseY) {
        ...
        DisplayUtils.drawRoundedRect(x - 2.0f + 0.5f, y - 2.0f, Fonts.montserrat.getWidth(bind, 5.5f, this.activated ? 0.1f : 0.05f) + 4.0f, 9.5f, 2.0f, ColorUtils.getColor(900));
        Fonts.montserrat.drawText(stack, bind, x, y, this.activated ? -1 : ColorUtils.rgba(255, 255, 255, 255), 5.5f, this.activated ? 0.1f : 0.05f);
