...
import im.expensive.ui.autobuy.SelectorUI;
...
implements IMinecraft {
    ...
    public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
        ...
        DisplayUtils.drawRoundedRect(this.x + 10.0f, this.y + height - 60.0f, width - 30.0f, 60.0f, 4.0f, ColorUtils.getColor(90));
        ...
        if (this.selecting) {
            ...
            for (AutoBuy buy : Expensive.getInstance().getAutoBuyHandler().items) {
                ...
                Fonts.montserrat.drawText(matrixStack, "\u0426\u0435\u043d\u0430: ", (int)(this.x + 13.0f + buyX), this.y + 40.0f + buyY, ColorUtils.rgba(255, 255, 255, 128), 5.0f, 0.05f);
                Fonts.montserrat.drawText(matrixStack, String.valueOf(buy.getPrice()), (float)((int)(this.x + 13.0f + buyX)) + Fonts.montserrat.getWidth("\u0426\u0435\u043d\u0430: ", 5.0f, 0.05f), this.y + 40.0f + buyY, ColorUtils.rgba(64, 255, 64, 128), 5.0f, 0.05f);
                float off = 0.0f;
                if (!buy.getEnchanments().isEmpty()) {
                    Fonts.montserrat.drawText(matrixStack, "\u0427\u0430\u0440\u044b: ", (int)(this.x + 13.0f + buyX), this.y + 40.0f + buyY + 10.0f, ColorUtils.rgba(255, 255, 255, 128), 5.0f, 0.05f);
                    for (Enchantment enchantment : buy.getEnchanments().keySet()) {
                        ...
                        Fonts.montserrat.drawText(matrixStack, enchText, (float)((int)(this.x + 13.0f + buyX)) + Fonts.montserrat.getWidth("\u0427\u0430\u0440\u044b: ", 5.0f, 0.05f) + off, this.y + 40.0f + buyY + 10.0f, ColorUtils.rgba(255, 255, 255, 128), 5.0f, 0.05f);
                ...
                buyX += widthPanel + 10.0f;
                if (this.x + buyX + 110.0f >= this.x + width - 10.0f) {
                    buyX = 0.0f;
                    buyY += 60.0f;
                }
                Scissor.unset();
    ...
    public boolean mouseClicked(double mouseX, double mouseY, int button) {
        ...
        if (this.selecting) {
            ...
            if (MathUtil.isHovered((float)mouseX, (float)mouseY, (float)(categoryX + 1) + 72.0f, categoryY + 1, 13.0f, 13.0f)) {
