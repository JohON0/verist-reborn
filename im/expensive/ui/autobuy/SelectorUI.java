...
implements IMinecraft {
    ...
    final Animation openAnimation = new EaseBackIn(100, 1.0, 1.0f);
    ...
    public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
        ...
        Block block2 = Block.getBlockFromItem(this.selected);
        if (block2 instanceof ShulkerBoxBlock) {
            ShulkerBoxBlock b = (ShulkerBoxBlock)block2;
    ...
    public void mouseClicked(double mouseX, double mouseY, int button) {
        ...
        if ((block2 = Block.getBlockFromItem(this.selected)) instanceof ShulkerBoxBlock) {
            ShulkerBoxBlock b = (ShulkerBoxBlock)block2;
